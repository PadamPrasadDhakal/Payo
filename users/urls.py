...
from .views import kyc_form_view, kyc_profile, notifications, notification_count_api, notifications_api
...
urlpatterns = [
    ...
    path("api/notifications/recent/", notifications_api, name="notifications_api"),
]
